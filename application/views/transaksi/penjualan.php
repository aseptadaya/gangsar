                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="penjualan-baru">
                                    ...
                                    <div class="box box-primary">
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form method="POST" action="<?php echo base_url()."transaksi/penjualan/insertPenjualan"?>" name="form-penjualan-baru" role="form-penjualan-baru">
                                            <div class="box-body">
                                                <div class="form-group">                                                
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="pemborong" class="form-control"  placeholder="Masukan Nama Pemborong" required data-validation-required-message="Mohon masukan nama pemborong">
                                                    </div>
                                                </div>
                                                <!-- /.box-body -->
